...
import {
  ...
  TabsTrigger,
  TabsContent,
} from 'H:/Med/medhub/src/components/ui/tabs.js'; // Ensure correct import for tabs components
...
const tabs = [
  ...
  { id: 'rebook', label: 'Book Appointment', icon: BookOpen, component: RebookAppointment },
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <AlertDialogContent open={showAchievement} onOpenChange={setShowAchievement}>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            You successfully managed your appointment!
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
